    ...
    fun success() {
        val response =
            given(this.spec)
                ...
                .filter(
                    document(
                        "post-interview-practice-history-star",
                        pathParameters(
                ...
                .`when`()
                .post("/api/v0/interview/practice/histories/{practiceHistoryPk}/star", 1001)

        response.statusCode shouldBe 200
        response.body.jsonPath().getBoolean("data.stared") shouldBe true
    }
}
